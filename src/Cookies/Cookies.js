  ...
  return (
    <div className="cookies" id="cookies">
      <div className="cookies__inner">
        <div className="cookies__inner__content">
          ...
          <div className="inner-text">
            ...
            betreiben, inklusive des Schutzes gegen Betrug oder Missbrauch sowie
            zur Reichweitenmessung. Letzterem kann in den Einstellungen
            ...
            Zugriff nehmen, ohne dass es einen Rechtsbehelf dagegen gibt.
            Sollten Sie die in diesem Absatz beschriebene Verarbeitung nicht
            wünschen, können Sie das Banner schließen. Ihre Einwilligung können
      ...
      <div className="cookies__inner__buttons">
        ...
        <span className="coockies-btn-blue" id="btn-blue">
          <a href="#1" class="cmpboxbtn cmpboxbtnyes cmptxt_btn_yes">
            <svg
      ...
      <div className="cookies__close" id="cookies-close"></div>
    </div>
  );
}
