...
export default class Responsive extends Component {
  render(e) {
    ...
    function onMouseEnter(e) {
      var target = e.target;
      var selector = target.closest("svg");
      addClass(selector);
    ...
    return (
      <section className="teaser-sc reveal">
                        ...
                        >
                          <div className="nx-tooltip">
                            <div class="nx-tooltip__content">
                              ...
                              <div class="nx-tooltip__description">
                                <div>
                                  <span>
                                    Inkl. 19,00 % MwSt. zzgl. 3.95 €
                                    <a
                                      rel="noopener noreferrer"
                                      href="https://www.nivea.de/ueber-uns/versandkosten"
                                      target="_blank"
                                      title="https://www.nivea.de/ueber-uns/versandkosten"
                                    >
                                      Versandkosten
                                    </a>
                                  </span>
                            ...
                            <div className="nx-tooltip__icon"></div>
                          </div>
                          <svg
