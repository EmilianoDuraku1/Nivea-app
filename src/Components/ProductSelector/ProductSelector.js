...
function ProductSelector() {
  return (
    <section className="product-selector">
      <h2 className="product-selector__headline reveal">
        Hallo, wie können wir helfen?
      </h2>

      <div className="product-selector__wrapper product-section">
        <div className="product-selector__item reveal">
          <a className="product-selector__link" href="/">
            ...
            <div className="product-selector__title">
              <span>Produkte</span>
            </div>
          </a>
        </div>
        <div className="product-selector__item reveal1">
          <a className="product-selector__link" href="/">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">
