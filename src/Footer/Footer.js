...
function Footer() {
  const footerAcordion = (e) => {
    var target = e.target;
    target.closest(".links-panel").classList.toggle("open");
  };
  const inputFocus = (e) => {
    var target = e.target;
    target.closest(".email-input").classList.add("open");
  };
  return (
          ...
          <div className="email">
            <div className="links-panel">
              ...
              <div className="email-content">
                ...
                <div className="email-input" onClick={(e) => inputFocus(e)}>
                  <div className="input">
          ...
          <div className="social">
            <div className="links-panel">
              ...
              <div className="social-content">
                <div className="social-wrapper-out">
                  <div className="social-wrapper-in">
                    <a
